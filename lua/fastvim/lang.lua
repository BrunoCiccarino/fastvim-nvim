...
L.typescript = {
    ...
    ["@lsp.mod.readonly.typescript"]                      = { link = "Boolean" },
    ...
    ["@lsp.typemod.enumMember.readonly.typescript"]       = { link = "Boolean" },
...
L.javascript = {
    ...
    ["@lsp.mod.readonly.javascript"]                       = { link = "Boolean" },
...
L.go = {
    ...
    ["@lsp.mod.readonly.go"]                     = { link = "Boolean" },
    ...
    ["@lsp.typemod.variable.readonly.go"]        = { link = "Boolean" },
...
L.python = {
    ["@constant.builtin.python"]                     = { fg = C.aurora.yellow, bg = C.none },
    ["@constant.python"]                             = { fg = C.frost.sea, bg = C.none },
    ["@field.python"]                                = { fg = C.fg, bg = C.none },
    ["@function.call.python"]                        = { fg = C.frost.turquoise, bg = C.none },
    ["@keyword.function.python"]                     = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.keyword.python"]                          = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.mod.defaultLibrary.python"]               = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.mod.definition.python"]                   = { fg = C.fg, bg = C.none },
    ["@lsp.mod.readonly.python"]                     = { link = "Boolean" },
    ["@lsp.type.function.python"]                    = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.type.keyword.python"]                     = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.type.namespace.python"]                   = { fg = C.none, bg = C.none },
    ["@lsp.type.operator.python"]                    = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.string.python"]                      = { fg = C.aurora.green, bg = C.none },
    ["@lsp.type.type.python"]                        = { link = "@type.python" },
    ["@lsp.type.typeParameter.python"]               = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.variable.python"]                    = { fg = C.fg, bg = C.none },
    ["@lsp.typemod.function.definition.python"]      = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.typemod.method.definition.python"]        = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.typemod.parameter.definition.python"]     = { fg = C.fg, bg = C.none },
    ["@lsp.typemod.type.defaultLibrary.python"]      = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.typemod.type.definition.python"]          = { fg = C.fg, bg = C.none },
    ["@lsp.typemod.typeParameter.definition.python"] = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.typemod.variable.defaultLibrary.python"]  = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.typemod.variable.definition.python"]      = { fg = C.fg, bg = C.none },
    ["@lsp.typemod.variable.readonly.python"]        = { link = "Boolean" },
    ["@method.call.python"]                          = { fg = C.frost.sea, bg = C.none },
    ["@method.python"]                               = { fg = C.frost.turquoise, bg = C.none },
    ["@module.python"]                               = { fg = C.fg, bg = C.none },
    ["@namespace.python"]                            = { fg = C.none, bg = C.none },
    ["@property.python"]                             = { fg = C.frost.turquoise, bg = C.none },
    ["@punctuation.bracket.python"]                  = { fg = C.frost.turquoise, bg = C.none },
    ["@string.escape.python"]                        = { fg = C.aurora.yellow, bg = C.none },
    ["@string.python"]                               = { fg = C.aurora.green, bg = C.none },
    ["@type.builtin.python"]                         = { fg = C.special.light_blue, bg = C.none },
    ["@type.definition.python"]                      = { fg = C.fg, bg = C.none },
    ["@type.python"]                                 = { fg = C.special.light_blue, bg = C.none },
    ["@variable.python"]                             = { fg = C.fg, bg = C.none },
    ["@variable.parameter.python"]                   = { fg = C.fg, bg = C.none },
    ["pythonBlock"]                                  = { fg = C.frost.turquoise, bg = C.none },
    ["pythonConditional"]                            = { fg = C.frost.light_blue, bg = C.none },
    ["pythonConst"]                                  = { fg = C.aurora.yellow, bg = C.none },
    ["pythonImport"]                                 = { fg = C.frost.sea, bg = C.none },
    ["pythonImportString"]                           = { fg = C.aurora.green, bg = C.none },
    ["pythonParen"]                                  = { fg = C.fg, bg = C.none },
    ["pythonSelf"]                                   = { fg = C.aurora.purple, bg = C.none },
}
...
L.lua = {
    ...
    ["@lsp.typemod.variable.defaultLibrary.lua"] = { fg = C.frost.sea, bg = C.none },
...
L.vimdoc = {
    ...
    ["@text.uri.vimdoc"]           = { fg = C.aurora.green, bg = C.none, underline = true, sp = C.aurora.green },
...
L.rust = {
    ["@constant.builtin.rust"]                  = { fg = C.aurora.yellow, bg = C.none },
    ["@constant.rust"]                          = { fg = C.frost.sea, bg = C.none },
    ["@field.rust"]                             = { fg = C.fg, bg = C.none },
    ["@function.call.rust"]                     = { fg = C.frost.turquoise, bg = C.none },
    ["@keyword.function.rust"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.keyword.rust"]                       = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.mod.defaultLibrary.rust"]            = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.mod.definition.rust"]                = { fg = C.fg, bg = C.none },
    ["@lsp.type.function.rust"]                 = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.type.keyword.rust"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.type.namespace.rust"]                = { fg = C.none, bg = C.none },
    ["@lsp.type.operator.rust"]                 = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.string.rust"]                   = { fg = C.aurora.green, bg = C.none },
    ["@lsp.type.type.rust"]                     = { link = "@type.rust" },
    ["@lsp.type.typeParameter.rust"]            = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.variable.rust"]                 = { fg = C.fg, bg = C.none },
    ["@method.call.rust"]                       = { fg = C.frost.sea, bg = C.none },
    ["@method.rust"]                            = { fg = C.frost.turquoise, bg = C.none },
    ["@module.rust"]                            = { fg = C.fg, bg = C.none },
    ["@namespace.rust"]                         = { fg = C.none, bg = C.none },
    ["@property.rust"]                          = { fg = C.frost.turquoise, bg = C.none },
    ["@punctuation.bracket.rust"]               = { fg = C.frost.turquoise, bg = C.none },
    ["@string.escape.rust"]                     = { fg = C.aurora.yellow, bg = C.none },
    ["@string.rust"]                            = { fg = C.aurora.green, bg = C.none },
    ["@type.builtin.rust"]                      = { fg = C.special.light_blue, bg = C.none },
    ["@type.definition.rust"]                   = { fg = C.fg, bg = C.none },
    ["@type.rust"]                              = { fg = C.special.light_blue, bg = C.none },
    ["@variable.rust"]                          = { fg = C.fg, bg = C.none },
    ["@variable.parameter.rust"]                = { fg = C.fg, bg = C.none },
    ["rustBlock"]                               = { fg = C.frost.turquoise, bg = C.none },
    ["rustConditional"]                         = { fg = C.frost.light_blue, bg = C.none },
    ["rustConst"]                               = { fg = C.aurora.yellow, bg = C.none },
    ["rustCrate"]                               = { fg = C.frost.sea, bg = C.none },
    ["rustMacro"]                               = { fg = C.aurora.purple, bg = C.none },
    ["rustLifetime"]                            = { fg = C.aurora.yellow, bg = C.none },
    ["rustKeyword"]                             = { fg = C.frost.light_blue, bg = C.none },
    ["rustType"]                                = { fg = C.special.light_blue, bg = C.none },
    ["rustFunction"]                            = { fg = C.frost.turquoise, bg = C.none },
}

L.c = {
    ["@constant.builtin.c"]                  = { fg = C.aurora.yellow, bg = C.none },
    ["@constant.c"]                          = { fg = C.frost.sea, bg = C.none },
    ["@field.c"]                             = { fg = C.fg, bg = C.none },
    ["@function.call.c"]                     = { fg = C.frost.turquoise, bg = C.none },
    ["@keyword.function.c"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.keyword.c"]                       = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.mod.defaultLibrary.c"]            = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.mod.definition.c"]                = { fg = C.fg, bg = C.none },
    ["@lsp.type.function.c"]                 = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.type.keyword.c"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.type.namespace.c"]                = { fg = C.none, bg = C.none },
    ["@lsp.type.operator.c"]                 = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.string.c"]                   = { fg = C.aurora.green, bg = C.none },
    ["@lsp.type.type.c"]                     = { link = "@type.c" },
    ["@lsp.type.typeParameter.c"]            = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.variable.c"]                 = { fg = C.fg, bg = C.none },
    ["@method.call.c"]                       = { fg = C.frost.sea, bg = C.none },
    ["@method.c"]                            = { fg = C.frost.turquoise, bg = C.none },
    ["@module.c"]                            = { fg = C.fg, bg = C.none },
    ["@namespace.c"]                         = { fg = C.none, bg = C.none },
    ["@property.c"]                          = { fg = C.frost.turquoise, bg = C.none },
    ["@punctuation.bracket.c"]               = { fg = C.frost.turquoise, bg = C.none },
    ["@string.escape.c"]                     = { fg = C.aurora.yellow, bg = C.none },
    ["@string.c"]                            = { fg = C.aurora.green, bg = C.none },
    ["@type.builtin.c"]                      = { fg = C.special.light_blue, bg = C.none },
    ["@type.definition.c"]                   = { fg = C.fg, bg = C.none },
    ["@type.c"]                              = { fg = C.special.light_blue, bg = C.none },
    ["@variable.c"]                          = { fg = C.fg, bg = C.none },
    ["@variable.parameter.c"]                = { fg = C.fg, bg = C.none },
    ["cBlock"]                               = { fg = C.frost.turquoise, bg = C.none },
    ["cConditional"]                         = { fg = C.frost.light_blue, bg = C.none },
    ["cConst"]                               = { fg = C.aurora.yellow, bg = C.none },
    ["cMacro"]                               = { fg = C.aurora.purple, bg = C.none },
    ["cKeyword"]                             = { fg = C.frost.light_blue, bg = C.none },
    ["cType"]                                = { fg = C.special.light_blue, bg = C.none },
    ["cFunction"]                            = { fg = C.frost.turquoise, bg = C.none },
}

L.cpp = {
    ["@constant.builtin.cpp"]                  = { fg = C.aurora.yellow, bg = C.none },
    ["@constant.cpp"]                          = { fg = C.frost.sea, bg = C.none },
    ["@field.cpp"]                             = { fg = C.fg, bg = C.none },
    ["@function.call.cpp"]                     = { fg = C.frost.turquoise, bg = C.none },
    ["@keyword.function.cpp"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.keyword.cpp"]                       = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.mod.defaultLibrary.cpp"]            = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.mod.definition.cpp"]                = { fg = C.fg, bg = C.none },
    ["@lsp.type.function.cpp"]                 = { fg = C.frost.turquoise, bg = C.none },
    ["@lsp.type.keyword.cpp"]                  = { fg = C.frost.light_blue, bg = C.none },
    ["@lsp.type.namespace.cpp"]                = { fg = C.none, bg = C.none },
    ["@lsp.type.operator.cpp"]                 = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.string.cpp"]                   = { fg = C.aurora.green, bg = C.none },
    ["@lsp.type.type.cpp"]                     = { link = "@type.cpp" },
    ["@lsp.type.typeParameter.cpp"]            = { fg = C.aurora.yellow, bg = C.none },
    ["@lsp.type.variable.cpp"]                 = { fg = C.fg, bg = C.none },
    ["@method.call.cpp"]                       = { fg = C.frost.sea, bg = C.none },
    ["@method.cpp"]                            = { fg = C.frost.turquoise, bg = C.none },
    ["@module.cpp"]                            = { fg = C.fg, bg = C.none },
    ["@namespace.cpp"]                         = { fg = C.none, bg = C.none },
    ["@property.cpp"]                          = { fg = C.frost.turquoise, bg = C.none },
    ["@punctuation.bracket.cpp"]               = { fg = C.frost.turquoise, bg = C.none },
    ["@string.escape.cpp"]                     = { fg = C.aurora.yellow, bg = C.none },
    ["@string.cpp"]                            = { fg = C.aurora.green, bg = C.none },
    ["@type.builtin.cpp"]                      = { fg = C.special.light_blue, bg = C.none },
    ["@type.definition.cpp"]                   = { fg = C.fg, bg = C.none },
    ["@type.cpp"]                              = { fg = C.special.light_blue, bg = C.none },
    ["@variable.cpp"]                          = { fg = C.fg, bg = C.none },
    ["@variable.parameter.cpp"]                = { fg = C.fg, bg = C.none },
    ["cppBlock"]                               = { fg = C.frost.turquoise, bg = C.none },
    ["cppConditional"]                         = { fg = C.frost.light_blue, bg = C.none },
    ["cppConst"]                               = { fg = C.aurora.yellow, bg = C.none },
    ["cppMacro"]                               = { fg = C.aurora.purple, bg = C.none },
    ["cppKeyword"]                             = { fg = C.frost.light_blue, bg = C.none },
    ["cppType"]                                = { fg = C.special.light_blue, bg = C.none },
    ["cppFunction"]                            = { fg = C.frost.turquoise, bg = C.none },
}
